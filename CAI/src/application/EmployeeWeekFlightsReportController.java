...
public class EmployeeWeekFlightsReportController {
	...
	private void refreshListView() {
        ...
        for (int i = 0; i < allFlights.size(); i++) {
        	...
        	if (flight.getDepartureDate().after(currentDate) && flight.getDepartureDate().before(currentDatePlusOneWeek)) {
        		weeklyFlightsData.add(flight.toString(true) + " || Empty Seats: " + (flight.getSeats() - flight.getSeatsTaken()));
        	}
		} 
